...
```{r}
epi_catalogue_list <- temporal_catalogue(x_rand, y_rand, test_rand, date_rand, link_d,prevalence, min_neighbours, time_width, min_date, max_date, time_steps, add_temporal_id = FALSE)
```

```{r}
epi_catalogue_list <- temporal_catalogue(x_rand, y_rand, test_rand, date_rand, link_d,prevalence, min_neighbours, time_width, min_date, max_date, time_steps, add_temporal_id = TRUE, linking_time = 3, linking_dist = 0.15, get_timelife = TRUE)
```
...
#Get temporal IDs
epi_catalogue_list_id <- temporal_catalogue(x_rand, y_rand, test_rand, date_rand, link_d, prevalence, min_neighbours, time_width, min_date, max_date, time_steps, add_temporal_id = TRUE, linking_time = linking_time, linking_dist = linking_dist, get_timelife = TRUE)
```
