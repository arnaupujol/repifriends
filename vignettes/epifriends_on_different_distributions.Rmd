...
# Clean missings
datarand <- clean_unknown_data(datarand)
datasin <- clean_unknown_data(datasin)
...
for(link_d in link_d_to_analyse){
  cat_rand <- catalogue(position_rand, test_rand$test, link_d, cluster_id = NULL, min_neighbours = min_neighbours)
...
#Random distribution
for(link_d in link_d_to_analyse){
  cat_sin <- catalogue(position_sin, test_sin$test, link_d, cluster_id = NULL, min_neighbours = min_neighbours)
...
#Random distribution
for(link_d in link_d_to_analyse){
  cat_clus <- catalogue(position_clus, test_clus$test, link_d, cluster_id = NULL, min_neighbours = min_neighbours)
